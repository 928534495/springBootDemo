        ...
        <nav class="navbar navbar-default pull-right" role="navigation">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active" ><a href="<%=request.getContextPath()%>/userControl/findIntegralPage">我的积分</a></li>
...
<%--                        </ul>--%>
<%--                    </div>--%>
                    <input id="fileName" type="text" class="input-lg" placeholder="查找积分">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#fileInfo").click(function () {
            ...
            var limit = 10;
            $.ajax({
                url: path + "/userControl/findIntegral",
                async: true,
                ...
                success: function (msg) {
                    ...
                    $(msg.data).each(function (i) {
                        $("#file").append("<div class=\"layui-colla-item row\" style='background-color: #7fcca8;'>\n" +
                            "            <h2 class=\"layui-colla-title\">文件名: &nbsp;" + msg.data[i].integralThing + "</h2>\n" +
                            // "            \n" +
                            // "            <div class=\"layui-colla-content layui-show layui-card-body\" style=' background-color: whitesmoke;'>\n" +
                            // "         <label>标题: &nbsp;" + msg.data[i].integralThing + "</label><br>\n" +
                            // "                <p>内容: &nbsp;" + msg.data[i].fileContent + "</p> \n" +
                            // "            </div>" +
                            " <br>\n" + " <div class=\"layui-row\">  " +
                            " <div class=\"layui-col-xs2\">  <span>文件:" + msg.data[i].integralFileId + "</span> </div>" +
                            " <div class=\"layui-col-xs2\">  <span>积分:" + msg.data[i].integralScore + "</span> </div>" +

                            " <div class=\"layui-col-xs2\">  <span>事件:" + msg.data[i].integralThing + "</span></div>" +
                            "<div class=\"layui-col-xs2\">   <span>时间: &nbsp;" + msg.data[i].integralUpdateTime + "</span> </div>" +
