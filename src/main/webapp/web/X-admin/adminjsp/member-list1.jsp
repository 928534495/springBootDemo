...
<%--                lay-data="{url:'./user.json',page:true,toolbar: '#toolbarDemo',id:'test'}"--%>
                <div class="layui-card-body ">
                    <table class="layui-table"  lay-filter="test">
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'username', width:220, sort: true, edit: 'text'}">用户名</th>
                            <th lay-data="{field:'password', edit: 'text', minWidth: 250}">密码</th>
                            <th lay-data="{field:'role', width:280,templet: '#switchTpl'}">角色</th>
